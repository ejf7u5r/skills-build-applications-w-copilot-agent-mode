...
mode: 'agent'
model: GPT-4.1
description: 'Update the OctoFit Tracker Django app with MongoDB connection, CORS, models, serializers, URLs, views, tests, and admin for users, teams, activities, leaderboard, and workouts.'
---
